...
@class PresenterModelEventViewTag, PresenterModelEvent, PresenterModelProviderError, PresenterArrow_coreEither<__covariant A, __covariant B>, PresenterKotlinUnit, PresenterModelObj, PresenterArrow_coreIor<__covariant A, __covariant B>, PresenterModelLevel, PresenterKoferoObj, PresenterKotlinException, PresenterInteractorImpl<V, P>, PresenterModelMove, PresenterModelCharacter, PresenterGamePresenterImpl, PresenterModelGame, PresenterPresenterImpl<V>, PresenterKotlinEnumCompanion, PresenterKotlinEnum<E>, PresenterKotlinArray<T>, PresenterModelEventValue, PresenterArrow_coreEitherCompanion, PresenterArrow_coreOption<__covariant A>, PresenterArrow_coreValidated<__covariant E, __covariant A>, PresenterArrow_coreIorCompanion, PresenterKotlinPair<__covariant A, __covariant B>, PresenterKotlinThrowable, PresenterArrow_coreOptionCompanion, PresenterArrow_coreEval<__covariant A>, PresenterArrow_coreValidatedCompanion, PresenterArrow_coreEvalCompanion, PresenterArrow_coreEvalAlways<__covariant A>, PresenterArrow_coreEvalLater<__covariant A>, PresenterKotlinNothing;

@protocol PresenterStateLogger, PresenterStateProvider, PresenterLoggingProvider, PresenterProvider, PresenterView, PresenterInteractor, PresenterStateReducer, PresenterRouter, PresenterPresenter, PresenterCharacterInteractor, PresenterCharacterPresenter, PresenterCharacterView, PresenterImageProvider, PresenterGameInteractor, PresenterGameView, PresenterGamePresenter, PresenterHomeInteractor, PresenterHomePresenter, PresenterHomeView, PresenterFavoritesProvider, PresenterModelError, PresenterMovePresenter, PresenterMoveView, PresenterRootPresenter, PresenterRootView, PresenterKotlinComparable, PresenterArrow_coreMonoid, PresenterArrow_coreSemigroup, PresenterKotlinIterator;
...
- (instancetype)initWithCharProvider:(id<PresenterProvider> _Nullable)charProvider moveProvider:(id<PresenterProvider> _Nullable)moveProvider imageProvider:(id<PresenterImageProvider> _Nullable)imageProvider __attribute__((swift_name("init(charProvider:moveProvider:imageProvider:)"))) __attribute__((objc_designated_initializer));
- (void)getId:(int32_t)id __attribute__((swift_name("get(id:)")));
...
@required
- (PresenterArrow_coreEither<PresenterModelProviderError *, PresenterKotlinUnit *> *)showFavs __attribute__((swift_name("showFavs()")));
- (PresenterArrow_coreEither<PresenterModelProviderError *, PresenterKotlinUnit *> *)showGames __attribute__((swift_name("showGames()")));
@end
